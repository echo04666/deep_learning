...
Step 1: generate text. Step 2: per-sentence toxic classification; publish only when all clear.
History: published texts saved under app/data/publish_history.json (local / Cloud ephemeral).

Layout follows 执行指南_代码生成规范.md: constants, loaders, helpers, then UI sections.
"""
